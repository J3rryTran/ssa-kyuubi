...
CREATE TABLE IF NOT EXISTS dbt_workspace(
    ...
    project_ref text NOT NULL, engine_profile_id varchar(128) NOT NULL,
...
CREATE TABLE IF NOT EXISTS dbt_job(
    ...
    name varchar(255) NOT NULL, action varchar(32) NOT NULL, selector text,
...
CREATE TABLE IF NOT EXISTS dbt_job_run(
    ...
    action varchar(32) NOT NULL, selector text, project_ref text NOT NULL, profile_id varchar(128) NOT NULL,
    profile_owner varchar(255) NOT NULL, profile_subdomain varchar(128) NOT NULL, profile_config text NOT NULL,
    ...
    started_at bigint, finished_at bigint, error_summary text, state_updated_at bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS dbt_job_run_log(
    ...
    end_offset bigint NOT NULL, content text NOT NULL, created_at bigint NOT NULL,
